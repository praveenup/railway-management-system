...
Begin VB.Form frmTrainBetStn 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdFind 
         Height          =   375
         Left            =   6600
         Picture         =   "frmTrainBetStn.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   1200
         Width           =   2295
   ...
   Begin VB.Image Image5 
      Height          =   5985
      Left            =   240
      Picture         =   "frmTrainBetStn.frx":319E
      Top             =   1320
      Width           =   825
   End
   Begin VB.Image Image4 
      Height          =   5985
      Left            =   16920
      Picture         =   "frmTrainBetStn.frx":137B8
      Top             =   1320
      Width           =   825
   End
   Begin VB.Image Image2 
      Height          =   420
      Left            =   11400
      Picture         =   "frmTrainBetStn.frx":23DD2
      Top             =   0
      Width           =   11535
   End
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   600
      Picture         =   "frmTrainBetStn.frx":242AC
      Top             =   0
      Width           =   720
   End
   Begin VB.Image Image3 
      Height          =   420
      Left            =   0
      Picture         =   "frmTrainBetStn.frx":24B08
      Top             =   0
      Width           =   11535
   End
End
Attribute VB_Name = "frmTrainBetStn"
...
Private Sub flexGridTrain_Click()
    If flexGridTrain.Rows > 1 Then
        ...
        frmTrainSchedule.txtTrainNo.Text = trainNo
        Call frmTrainSchedule.cmdSchedule_Click
