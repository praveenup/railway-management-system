...
Begin VB.Form frmSeatAvailablityUser 
   BackColor       =   &H8000000E&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCheck 
         Height          =   375
         Left            =   6000
         Picture         =   "frmSeatAvailablityUser.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   3480
         Width           =   3135
      ...
      Begin VB.Image Image2 
         Height          =   405
         Left            =   0
         Picture         =   "frmSeatAvailablityUser.frx":4356
         Top             =   0
         Width           =   16005
      End
      Begin VB.Image Image7 
         Height          =   405
         Left            =   0
         Picture         =   "frmSeatAvailablityUser.frx":19584
         Top             =   4200
         Width           =   16005
      End
      Begin VB.Image Image8 
         Height          =   5925
         Left            =   0
         Picture         =   "frmSeatAvailablityUser.frx":2E7B2
         Top             =   0
         Width           =   14790
      End
   End
   ...
   Begin VB.Image Image6 
      Height          =   720
      Left            =   480
      Picture         =   "frmSeatAvailablityUser.frx":14BF24
      Top             =   0
      Width           =   720
   End
   ...
   Begin VB.Image Image5 
      Height          =   5985
      Left            =   120
      Picture         =   "frmSeatAvailablityUser.frx":14C86F
      Top             =   840
      Width           =   825
   End
   Begin VB.Image Image4 
      Height          =   5985
      Left            =   15720
      Picture         =   "frmSeatAvailablityUser.frx":15CE89
      Top             =   840
      Width           =   825
   End
   Begin VB.Image Image1 
      Height          =   420
      Left            =   11520
      Picture         =   "frmSeatAvailablityUser.frx":16D4A3
      Top             =   0
      Width           =   11535
   End
   Begin VB.Image Image3 
      Height          =   420
      Left            =   0
      Picture         =   "frmSeatAvailablityUser.frx":16D97D
      Top             =   0
      Width           =   11535
   End
End
Attribute VB_Name = "frmSeatAvailablityUser"
