...
Begin VB.Form frmFareEnquiry 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdGetFare 
         Height          =   615
         Left            =   6120
         Picture         =   "frmFareEnquiry.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   2640
         Width           =   1455
      ...
      Begin VB.ComboBox cmbCoach 
         ...
         EndProperty
         Height          =   420
         ItemData        =   "frmFareEnquiry.frx":32A6
         Left            =   2880
         List            =   "frmFareEnquiry.frx":32A8
         TabIndex        =   4
         Top             =   1920
         Width           =   2895
      End
      ...
      Begin VB.PictureBox Picture1 
         ...
         Height          =   2055
         Left            =   7920
         Picture         =   "frmFareEnquiry.frx":32AA
         ScaleHeight     =   2025
         ScaleWidth      =   5505
         TabIndex        =   15
         Top             =   2040
   ...
   Begin VB.Image Image4 
      Height          =   5985
      Left            =   14640
      Picture         =   "frmFareEnquiry.frx":120A1C
      Top             =   1320
      Width           =   825
   End
   Begin VB.Image Image5 
      Height          =   5985
      Left            =   120
      Picture         =   "frmFareEnquiry.frx":131036
      Top             =   1320
      Width           =   825
   End
   ...
   Begin VB.Image Image6 
      Height          =   720
      Left            =   480
      Picture         =   "frmFareEnquiry.frx":141650
      Top             =   0
      Width           =   720
   End
   Begin VB.Image Image1 
      Height          =   420
      Left            =   11520
      Picture         =   "frmFareEnquiry.frx":141F9B
      Top             =   0
      Width           =   11535
   End
   Begin VB.Image Image3 
      Height          =   420
      Left            =   0
      Picture         =   "frmFareEnquiry.frx":142475
      Top             =   0
      Width           =   11535
   End
End
Attribute VB_Name = "frmFareEnquiry"
